...
class ScenariosTests(EthBaseTest):
    ...
    def test_scenario_1(self):
        ...
        self.fundsManagerContract.proposeTransaction(GS_PROJECT_ID, [self.tokenContract.address], [self.DECIMALS],
                                                     ...
                                                     private_key=self.accounts[0].key)
        # vote only for 4
        self.proposalContract.vote(GS_PROJECT_ID, proposal_id + 1, True,
                                   private_key=self.accounts[1].key)
        self.proposalContract.vote(GS_PROJECT_ID, proposal_id + 1, True,
                                   private_key=self.accounts[2].key)
        self.proposalContract.vote(GS_PROJECT_ID, proposal_id + 1, False,
    ...
    def test_scenario_3(self):
        ...
        self.assertEqual(self.delegatesContract.delegateOf(GS_PROJECT_ID, self.accounts[3].address), ZERO_ETH_ADDRESS)
        self.assertEqual(self.delegatesContract.delegateOf(GS_PROJECT_ID, self.accounts[1].address), ZERO_ETH_ADDRESS)

        self.assertEqual(self.delegatesContract.delegations(GS_PROJECT_ID, self.accounts[4].address, 0),
                         self.accounts[5].address)
        self.assertEqual(self.delegatesContract.delegations(GS_PROJECT_ID, self.accounts[4].address, 1),
        ...
        self.assertEqual(self.delegatesContract.delegateOf(GS_PROJECT_ID, self.accounts[4].address),
                         self.accounts[8].address)
        self.assertEqual(self.delegatesContract.delegations(GS_PROJECT_ID, self.accounts[8].address, 0),
        ...
        self.assertEqual(self.delegatesContract.delegateOf(GS_PROJECT_ID, self.accounts[0].address),
                         self.accounts[4].address)
        self.assertEqual(self.delegatesContract.delegations(GS_PROJECT_ID, self.accounts[4].address, 2),
