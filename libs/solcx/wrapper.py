...
from libs.solcx import install
from libs.solcx.exceptions import SolcError, UnknownOption, UnknownValue
...
def solc_wrapper(
    ...
    **kwargs : Any
    ...
    if proc.returncode != success_return_code and ('help' not in kwargs or kwargs['help'] is False):
