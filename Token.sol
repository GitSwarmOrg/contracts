...
contract Token is ERC20interface, Constants, Common {
    ...
    constructor(string memory prjId, uint supply, uint creatorSupply, address contractsManagerAddress, string memory tokenName, string memory tokenSymbol) {
